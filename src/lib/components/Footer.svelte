    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div>
        <div class="flex items-center gap-2.5 mb-4">
          <img src="{assets}/icon.png" alt="Kaiden" width="28" height="28" style="border-radius: 22%; box-shadow: 0 2px 8px rgba(0,0,0,0.18)" />
      ...
      {#each links as group}
        <div>
          <p class="text-[11px] font-mono uppercase tracking-widest mb-4" style="color: var(--text-muted)">{group.group}</p>
